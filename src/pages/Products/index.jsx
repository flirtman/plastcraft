        ...
        <div className={'plastcraft-products-wrap'}>
            ...
            <div className="container" style={{marginBottom: '100px'}}>
                ...
                <Row>
                    ...
                    <Col xs={{span: 12, order: 4 }} lg={{span: 6, order: 4 }} className={'img-col'} style={{backgroundImage: `url(${LLDPE})`}}></Col>

                    <Col xs={{span: 12, order: 6 }} lg={{span: 6, order: 5 }} className={'img-col'} style={{backgroundImage: `url(${HDPE})`}}></Col>
                    ...
                    <Col xs={{span: 12, order: 8 }} lg={{span: 6, order: 8 }} className={'img-col'} style={{backgroundImage: `url(${PP})`}}></Col>

                    <Col xs={{span: 12, order: 10 }} lg={{span: 6, order: 9 }} className={'img-col'} style={{backgroundImage: `url(${ABS})`}}></Col>
